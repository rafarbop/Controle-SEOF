document.body.onload = () => {
    ...
    <nav class="has-background-success-dark" role="navigation" aria-label="main navigation">
        <div class="is-flex is-justify-content-space-evenly">
            <a href="/" class="button is-primary is-inverted is-outlined">Lista de Empenhos</a>
            <a href="/api-to-database.html" class="button is-primary is-inverted is-outlined">Consultar Novos empenhos</a>
        </div>
    </nav>`
}